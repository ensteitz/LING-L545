...
for line in sentence:
	print(line, file=txt_write)	# Store the output in a file that contains only the sentences and their polarities
	print(analyser.polarity_scores(line), file=txt_write)
	print("------------\n", file=txt_write) # Do this so that it is easier to see each sentence
